  ...
  return (
    <PageLayout title='Apartamento en Piriápolis' showGoBack={true}>
      ...
      <PropertyDetails
        ...
        observations={['Luz y agua incluídos en el precio.', 'Mínimo de alquiler 4 noches en Enero y Febrero y 4 noches en los demás meses.', 'Horario check in: 10:00', 'Horario check out: 12:00']}
