  ...
  return (
    <PageLayout title='Casa en Punta Negra' showGoBack={true}>
      ...
      <PropertyDetails
        ...
        observations={['Para reservar se debe abonar el 30% del precio total, el resto se paga al llegar.', 'Luz y agua incluídos en el precio.', 'Mínimo de alquiler dos días.', 'Horario check in: 10:00', 'Horario check out: 12:00']}
